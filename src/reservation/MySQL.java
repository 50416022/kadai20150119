...
public class MySQL {
   ...
   ResultSet rs;  
    ...
    public MySQL() {
        ...
        this.dbname  = "50416022";         // データベース名;
        this.url = "jdbc:mysql://" + server + "/" + dbname + "?useUnicode=true&characterEncoding=UTF-8";
        this.user = "50416022";         // データベース作成ユーザ名;
        this.password  = "50416022";     // データベース作成ユーザパスワード;
...
public ResultSet getReservation(String rdate, String facility){
	...
	public ResultSet getFacilityInfo(String facility_name){
	...
	public ResultSet getcheckReservation(){
	...
	public int setCancelReservation(String rdate,String  st,String  et,String  facility){

        int rs_int = 0;
        String sql = "DELETE FROM reservation WHERE facility_name ='" + facility +""
        		+ "' AND date = '" + rdate + "' AND start_time = '" + st + "' AND end_time = '" + et + "';";
